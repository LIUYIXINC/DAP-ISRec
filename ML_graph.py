...
# 使用Pickle序列化图数据
with open('Data/Movielens 1M/G11.pkl', 'wb') as f:
    pickle.dump(G1, f)
# 从文件中加载图数据
with open('Data/Movielens 1M/G11.pkl', 'rb') as f:
    G = pickle.load(f)
# 验证图数据是否加载正确
...
with open('Data/Movielens 1M/G22.pkl', 'wb') as f:
    pickle.dump(G2, f)
...
with open('Data/Movielens 1M/G33.pkl', 'wb') as f:
    pickle.dump(G3, f)
